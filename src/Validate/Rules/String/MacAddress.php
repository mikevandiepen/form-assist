...
class MacAddress implements ValidationInterface
{
    use AttributesTrait;
    ...
    public function validate() : string
    {
        ...
        if (!(filter_var($this->values[0], FILTER_VALIDATE_MAC))) {
            $response->add($this->getMessage('mac_address'), $this->getAttributes(), Response::ERROR, true, ['<strong>', '</strong>']);
        }
