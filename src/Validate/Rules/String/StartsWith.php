...
class StartsWith implements ValidationInterface
{
    ...
    public function validate() : string
    {
        ...
        if (!(substr_compare($this->values[0], $this->parameters[0], 0, strlen($this->parameters[0])) === 0)) {
            $response->add($this->getMessage('starts_with'), $this->getAttributes(), Response::ERROR, true, ['<strong>', '</strong>']);
        }
