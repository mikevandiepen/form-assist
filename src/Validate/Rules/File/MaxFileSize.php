...
class MaxFileSize implements ValidationInterface
{
    ...
    public function validate() : string
    {
        ...
        if (!(filesize($this->values[0]) <= $this->parameters[0])) {
            $response->add($this->getMessage('file_max_size'), $this->getAttributes(), Response::ERROR, true, ['<strong>', '</strong>']);
        }
